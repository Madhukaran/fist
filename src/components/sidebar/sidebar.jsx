...
import sm_toogler from '../../gif/sm_toogler.json'
            ...
            <div>
                ...
                <div class="product_options">
                    <div class="product_tag">
                        <div class="content-wrapper">
                            <div class="product_icon">
                                <img src="house-fill.svg" alt="behance" />
                            </div>
                            <div class="product_title">
                    ...
                    <div class="product_tag">
                        <div class="content-wrapper">
                            <div class="product_icon">
                                <img src="bell-fill.svg" alt="behance" />
                            </div>
                            <div class="product_title">
                    ...
                    <div class="product_tag">
                        <div class="content-wrapper">
                            <div class="product_icon">
                                <img src="chat-right-quote-fill.svg" alt="behance" />
                            </div>
                            <div class="product_title">
                    ...
                    <div class="product_tag">
                        <div class="content-wrapper">
                            <div class="product_icon">
                                <img src="bookmarks-fill.svg" alt="behance" />
                            </div>
                            <div class="product_title">
                    ...
                    <div class="product_tag">
                        <div class="content-wrapper">
                            <div class="product_icon">
                                <img src="view-list.svg" alt="behance" />
                            </div>
                            <div class="product_title">
                    ...
                    <div class="product_tag">
                        <div class="content-wrapper">
                            <div class="product_icon">
                                <img src="person-workspace.svg" alt="behance" />
                            </div>
                            <div class="product_title">
                    ...
                    <div class="product_tag">
                        <div class="content-wrapper">
                            <div class="product_icon">
                                <img src="three-dots-vertical.svg" alt="behance" />
                            </div>
                            <div class="product_title">
